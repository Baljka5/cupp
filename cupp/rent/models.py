...
class StrRent(models.Model):
    ...
    lesser2 = models.CharField('Түрээслүүлэгч 2', null=True, max_length=100)
    ...
    phone_number2 = models.IntegerField('Холбоо барих утас 2', null=True, default=0)
    ...
    rent_mo_fee_annex1 = models.IntegerField('Түрээсийн төлбөр 1', null=True, default=0)
    ...
    other_cnt = models.CharField('Бусад орлого болон зардлын гэрээ', null=True, max_length=30)
    ...
    sublet1_cnt_no = models.CharField('1 Дамжуулан түрээсийн гэрээний дугаар', null=True, max_length=30)
    sublet1_size = models.IntegerField('1 Дамжуулан түрээсийн талбай хэмжээ', null=True, default=0)
    sublet1_rent = models.IntegerField('1 Дамжуулан түрээсийн үнэ ', null=True, default=0)
    sublet1_deposit = models.IntegerField('1 Дамжуулан түрээсийн барьцаа төлбөр', null=True, default=0)
