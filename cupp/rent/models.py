...
class StrRent(models.Model):
    ...
    orther_cnt = models.CharField('Бусад орлого болон зардлын гэрээ', blank=True, null=True, max_length=30)
    ...
    other_cnt = models.CharField('Бусад гэрээ', blank=True, null=True, max_length=200)
