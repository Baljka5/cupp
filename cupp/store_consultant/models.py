...
class StoreConsultant(m.Model):
    ...
    sm_num = m.IntegerField('Дэлгүүрийн менежерийн тоо', blank=True, null=True, default=0)
    am_num = m.IntegerField('Дэлгүүрийн туслах менежерийн тоо', blank=True, null=True, default=0)
